...
public class NouveauClient extends java.awt.Panel {
	    ...
	    public NouveauClient(Main main, VueGlobalNvClient vue, String cc, String nc, JComboBox tournee) {
	    	main_ = main;
	    ...
	    private void initComponents(String cc, String nc, JComboBox tournee) {
